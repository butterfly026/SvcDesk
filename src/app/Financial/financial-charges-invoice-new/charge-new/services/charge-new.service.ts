...
export class ChargeNewService {
    ...
    ChargeTax(ContactCode, DefinitionId, Amount): Observable<any> {
        const header = new HttpHeaders()
            .set('Authorization', this.tokens.AccessToken);
        ...
        return this.httpClient.get<any>(this.config.NewAPIEndPoint + '/Charges/Taxes/Accounts/' + ContactCode + '/DefinitionId/' + DefinitionId + '/Amount/' + Amount, {
            headers: header,
            params: reqParam
        });
    }
