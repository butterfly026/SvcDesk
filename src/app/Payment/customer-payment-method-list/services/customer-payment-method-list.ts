...
export class CustomerPaymentMethodListService {
    ...
    getMethodList(): Observable<CustomerPaymentMethodListItem[]> {
        ...
        return this.httpclient.get<CustomerPaymentMethodListItem[]>(this.config.MockingAPIEndPoint + 'Payment/1.0.0/CustomerPaymentMethodList',
