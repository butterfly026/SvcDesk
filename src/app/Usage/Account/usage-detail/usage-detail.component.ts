import { AfterContentChecked, ChangeDetectorRef, TemplateRef, Component, EventEmitter, Input, OnInit, Output, ViewChild, SimpleChanges } from '@angular/core';
...
import { ContactUsageDetails, TariffValues } from '../../models';
...
export class UsageDetailComponent implements OnInit {
  ...
  totalCount: number = 0;
  dataSource: ContactUsageDetails[] = [];
