...
export class UsageHistoryService {
    ...
    getUsageHistory(reqData: GetServiceUsageHistory, ServiceReference): Observable<any> {
        ...
        return this.httpClient.get<any>(this.config.NewAPIEndPoint + '/UsageTransactions/Services/' + ServiceReference, {
