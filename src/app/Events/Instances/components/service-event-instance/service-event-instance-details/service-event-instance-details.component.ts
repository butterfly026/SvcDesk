...
@Component({
  selector: 'app-service-event-instance-details',
  templateUrl: './service-event-instance-details.component.html',
  styleUrls: ['./service-event-instance-details.component.scss'],
})
export class ServiceEventInstanceDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ServiceEventInstanceDetailsComponent>,
