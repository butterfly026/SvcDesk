...
import { EditContactEventInstance } from './contact-event-instance-edit.types';
...
@Component({
  ...
  templateUrl: './contact-event-instance-edit.component.html',
  styleUrls: ['./contact-event-instance-edit.component.scss'],
})
export class ContactEventInstanceEdit implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ContactEventInstanceEdit>,
