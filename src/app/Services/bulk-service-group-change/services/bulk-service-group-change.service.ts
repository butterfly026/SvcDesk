...
export class BulkServiceGroupChangeService {
    ...
    getGroupDisplayList(): Observable<GroupDisplayItem[]> {
        ...
        // return this.httpclient.get<any>(this.config.MockingAPIEndPoint + 'ServiceGroups/1.0.0/ServiceGroupDisplayList', {
        //     headers: header, params: reqParam
        // });
    }
